...
#[tokio::test]
async fn tools_list_has_ten_tools_by_default() {
    ...
    expected.sort();
    assert_eq!(names, expected, "default mode exposes 10 tools");
...
#[tokio::test]
async fn tools_list_has_eleven_tools_with_allow_writes() {
    ...
    expected.sort();
    assert_eq!(names, expected, "--allow-writes exposes 11 tools");
...
#[tokio::test]
async fn tools_list_has_eight_tools_in_passive_mode() {
