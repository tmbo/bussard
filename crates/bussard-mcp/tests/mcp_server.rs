...
#[tokio::test]
async fn tools_list_has_fourteen_tools_by_default() {
    ...
    assert_eq!(
        names, expected,
        "default mode exposes 10 bus/model tools, the 2 history read tools and the 2 bundle/diff tools"
    );
...
#[tokio::test]
async fn tools_list_has_twelve_tools_in_passive_mode() {
