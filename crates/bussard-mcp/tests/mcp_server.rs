...
#[tokio::test]
async fn tools_list_has_fifteen_tools_by_default() {
    ...
    assert_eq!(
        names, expected,
        "default mode exposes 11 bus/model tools, the 2 history read tools and the 2 bundle/diff tools"
    );
...
#[tokio::test]
async fn tools_list_has_seventeen_tools_with_allow_writes() {
...
#[tokio::test]
async fn tools_list_has_thirteen_tools_in_passive_mode() {
