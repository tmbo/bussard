...
impl BussardMcp {
    ...
    pub fn new(state: Arc<SharedState>) -> Self {
        ...
        // learn/acceptance tools and the bundle/diff tools live in separate
        // `#[tool_router]` impl blocks (see `crate::tools_model`,
        // `crate::tools_groups`, `crate::tools_learn` and `crate::tools_diff`);
        // rmcp's `ToolRouter` implements `Add`, so they combine into one
        // instance router, then get trimmed for this tier.
